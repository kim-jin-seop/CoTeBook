...
declare const loadTsConfig: (dir?: string, name?: string, __files?: string[]) => Loaded | null;
...
export { GetOutputFile, JS_EXT_RE, Options, RequireFunction, bundleRequire, dynamicImport, externalPlugin, jsoncParse, loadTsConfig, match, replaceDirnamePlugin, tsconfigPathsToRegExp };
